...
class ControllerTest extends TestCase
{
    ...
    public function testBindOnFrozenControllerShouldThrowException(): void
    {
     ...
     */
    public function testDefaultRouteNameGeneration(Route $route, $prefix, $expectedRouteName): void
    {
